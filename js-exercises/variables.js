...
console.log("Exercise 6 Answer: num1 values are between 1 and 10, NOT inclusive of 1 and 10 . Explicitly those values are: 2,3,4,5,6,7,8, and 9; assuming whole numbers. num2 values are similar to the rule for num1, except that they ARE inclusive (as denoted by the '=' sign). So, explicitly those values are: 1,2,3,4,5,6,7,8,9, and 10.")
...
console.log("The sum is " + theProduct + ".");
...
const myAnswerForExercise10 = "The data type of dreamDestination is string.";
console.log(myAnswerForExercise10);

// Exercise 11. What is the data type of the value stored in 'product',
// place your answer in the quotes below:

const myAnswerForExercise11 = "The data type of product is number.";
console.log(myAnswerForExercise11);

// Exercise 12. What do you think the value of emptyVariable is?
// Place your answer below:

const myAnswerForExercise12 = "The value of emptyVariable might be NULL.";
console.log(myAnswerForExercise12);
